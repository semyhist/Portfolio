export const ceviriler = {
  tr: {
    ...
    contact: {
      title: "İletişim",
      desc: "Projeler, işbirlikleri veya herhangi bir konu için benimle iletişime geçebilirsiniz.",
      form: { name: "Adınız", email: "E-posta Adresiniz", subject: "Konu", message: "Mesajınız", send: "Mesaj Gönder", sending: "Gönderiliyor...", success: "Mesajınız başarıyla gönderildi!", error: "Mesaj gönderilemedi. Lütfen tekrar deneyin." }
    },
  ...
  en: {
    ...
    contact: {
      ...
      form: { name: "Your Name", email: "Your Email", subject: "Subject", message: "Your Message", send: "Send Message", sending: "Sending...", success: "Your message has been sent successfully!", error: "Message could not be sent. Please try again." }
    },
...
export const translations = ceviriler;
