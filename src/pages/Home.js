          ...
          >
            ...
            >
              {[
                ...
                {
                  href: "https://instagram.com/semjhaydin",
                  icon: Instagram,
                  label: "Instagram",
                },
                {
                ...
                {
                  href: "https://youtube.com/@semjhaydin",
                  icon: Youtube,
                  label: "YouTube",
                },
              ].map((social) => {
          ...
          <div className="container">
            ...
            <div className="skills-grid">
              {[
                ...
                {
                  icon: Brain,
                  title: ceviriler.skills.problem.title,
                  description: ceviriler.skills.problem.desc,
                },
              ].map((skill, index) => {
          ...
          <div className="container">
            ...
            <div className="projects-grid">
              {[
                ...
                {
                  id: 'mobile',
                  title: ceviriler.projects.mobile.title,
                  description: ceviriler.projects.mobile.desc,
                  tags: [
                    "React Native",
                    "JavaScript",
                    "Mobile UI",
